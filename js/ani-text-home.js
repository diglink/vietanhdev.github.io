...
$(document).ready(function(){
	...
	function helloWorld(){
		...
		$(".page-heading").html("<div class='text-editor-wrap'><div class='title-bar'><span class='title'>vietanh@Xmachine</span></div><div class='text-body'>$ <span id='typed'></span></div></div>");
		$("#typed").typed({
